...
class CreatedWithRelationsMessage
{
    ...
    public function handle(CreatedWithRelationsMessageEvent $event)
    {
        ...
        $main_id = $event->message->main_id ?? $message_id;
        ...
        $message_statistic_class::updateOrCreate(
            ...
            $attributes + [
                'count' => $count,
                'last_id' => $message_id,
                'last_at' => $event->message->created_at,
            ]
        );

        $this->updateMemberMessageStatistic($main_id, $event->message->members, $count);
        $this->updateMemberStatistic($main_id, $event->message->members);
    }
